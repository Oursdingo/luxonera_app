...
export default function WhatsAppCheckout() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 space-y-6">
      <h2 className="text-2xl md:text-3xl font-display">Finaliser la commande</h2>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:outline-none focus:border-black transition-colors"
            required
          />
        </div>
      ...
      <Button
        ...
        className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-4 px-8 rounded-lg font-medium flex items-center justify-center gap-3 transition-colors text-lg"
      >
